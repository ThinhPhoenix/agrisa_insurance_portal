...
import { useCreateCrop } from "../hooks/mockup";

const { Title, Text } = Typography;

export default function CreateCropPage() {
    const router = useRouter();
    const { loading, contextHolder, handleSubmit, filterOptions } = useCreateCrop();
            ...
            <Space direction="vertical" size="large" style={{ width: '100%' }}>
                ...
                <Space direction="vertical" style={{ width: '100%' }}>
                    ...
                    <div>
                        ...
                        <Text type="secondary">
                            Điền thông tin để tạo một cây trồng mới trong hệ thống
                        </Text>
                    </div>
                </Space>
