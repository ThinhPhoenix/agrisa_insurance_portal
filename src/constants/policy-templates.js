...
export const POLICY_TEMPLATES = [
  {
    ...
    category: "Lúa (Rice)",
    description:
      "Gói bảo hiểm sử dụng chỉ số NDVI từ vệ tinh để giám sát sức khỏe cây lúa. Phát hiện sớm khi cây bị stress hoặc bệnh hại.",
    icon: "🌾",
    difficulty: "Dễ",
    recommended: true,
    basicData: {
  ...
  },
  {
    ...
    category: "Lúa (Rice)",
    description:
      "Gói bảo hiểm sử dụng chỉ số NDMI từ vệ tinh để phát hiện thiếu nước. Phù hợp cho mùa khô.",
    icon: "🌾",
    difficulty: "Dễ",
    recommended: true,
    basicData: {
  ...
  },
  {
    ...
    category: "Lúa (Rice)",
    description:
      "Gói bảo hiểm cao cấp kết hợp NDVI và NDMI để giám sát toàn diện sức khỏe cây và tình trạng nước. Bảo vệ tối ưu.",
    icon: "🌾",
  ...
  },
  {
    ...
    description:
      "Bảo vệ cây cà phê bằng giám sát chỉ số NDVI. Phát hiện sớm bệnh hại, sâu bệnh và stress nhiệt.",
    icon: "☕",
    difficulty: "Trung bình",
    recommended: false,
    basicData: {
