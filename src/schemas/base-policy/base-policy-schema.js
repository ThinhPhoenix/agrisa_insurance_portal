...
const BasePolicyStatus = z.enum(["draft", "active", "archived"], {
...
export const basePolicySchema = z
  .object({
    ...
    insuranceProviderId: z
      .string({
        required_error: getBasePolicyError("INSURANCE_PROVIDER_ID_REQUIRED"),
      })
    ...
    coverageCurrency: z
      .string({
        required_error: getBasePolicyError("COVERAGE_CURRENCY_REQUIRED"),
      })
    ...
    coverageDurationDays: z
      .number({
        ...
        invalid_type_error: getBasePolicyError("COVERAGE_DURATION_INVALID"),
      })
      .int()
    ...
    isPerHectare: z.boolean({
      ...
      invalid_type_error: getBasePolicyValidation("IS_PER_HECTARE_REQUIRED"),
    }),
    ...
    insuranceValidFrom: z
      ...
      .refine((val) => val !== null && val !== undefined, {
        message: getBasePolicyValidation("INSURANCE_VALID_FROM_REQUIRED"),
      }),

    insuranceValidTo: z
      .any({
        required_error: getBasePolicyValidation("INSURANCE_VALID_TO_REQUIRED"),
      })
      .refine((val) => val !== null && val !== undefined, {
    ...
    documentValidationStatus: DocumentValidationStatus.optional().nullable(),
