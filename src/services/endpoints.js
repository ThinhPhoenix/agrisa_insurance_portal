...
export const endpoints = {
    ...
    policy: {
        ...
        policy: {
            ...
            listDataBill: `policy/protected/api/v2/data-bill`,
            dataBillCost: (basePolicyId) =>
                `/policy/protected/api/v2/data-bill/cost/${basePolicyId}`,
        },
    },
    applications: {
    ...
    payment: {
        createPaymentLink: `/payment/protected/link`,
